...
We will consider 2 scenarios for the change in the cost of transport. Given the original parameter as $\beta$, the parameters $\beta_1, \beta_2$ for the two scenarios B1 and B2 will be modified as follows.
...
In scenario A, we have observed a significant drop in the number of journeys terminating at Canary Wharf.
